                ...
                <div class="space-y-2">
                        <label class="dropdown">
                            <div class="cover">
                                ...
                                <p class="pointer-none"><span>Перетащите</span> фаил
                                    сюда <br/> или <a style="text-decoration: underline; color: rgb(59, 130, 246);" class="text-blue-600 hover:underline">кликните</a> тут</p>
                            </div>
