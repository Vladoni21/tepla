        ...
        <header class="course__level-header">
            <article>
                ...
                <div class="course__level-header-text ng-star-inserted">
                    ...
                    design, including its importance, principles, and process. Explore user research, personas, user
                    journeys,
                    wireframes, and more!
                </div>
            </article>
...
.course__level-footer:not(:first-child) {
    margin-top: 40px;
}

.course__level-footer {
    display: flex;
    flex-direction: column;
    align-items: center;
