  ...
  <div>
    ...
    <div class="c-formContainer">
      <form class="c-form" action="">
        <input class="c-form__input" placeholder="Ответ" type="email"
               pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" required>
        <label class="c-form__buttonLabel" for="checkbox">
          <button class="c-form__button" type="button">A</button>
        </label>
        <label class="c-form__toggle" for="checkbox" data-title="Понял(а)"></label>
      </form>
    </div>
  </div>
</template>
